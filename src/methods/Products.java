...
public class Products {
	...
	void displayProducts() {
		...
		while (!isValidBrandSelected) {
			...
			// Calling the nextLine() method Of sc class - Calling method from another
			// class or Invoking a method from another class
	...
	void addToCart() {
		...
		System.out.println(
				product.name + "is in stock : " + inStock + " and no of quantity available :" + product.quantity);
